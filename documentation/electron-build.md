...
2. Run the Electron packaging script:
   ...
   ```
3. Find installers or unpacked builds under the Electron output directory configured in `scripts/build_desktop.js`.

## Notes
- Update application icons and metadata inside `electron/` before shipping.
