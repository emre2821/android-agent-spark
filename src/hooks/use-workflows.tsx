...
import { type WorkflowUpsert, createWorkflowService } from '@/lib/workflows/service';
...
export { createInMemoryWorkflowsManager } from '@/lib/workflows/controller';
export type {
  CreateWorkflowInput,
  UpdateWorkflowInput,
  WorkflowsManager,
} from '@/lib/workflows/controller';
export type { WorkflowUpsert } from '@/lib/workflows/service';
